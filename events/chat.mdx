...
Players can chat with opponents and admins during events. Chat is availble to all players in the event and the admins. The chat can be accessed from the event page under the `Chat` tab.
