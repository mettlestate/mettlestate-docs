...
Event registration is the process of registering for an event as a solo player or a team. Players can manage their own registrations, and admins have accessibility to assist on the backend. 
...
- Check in to the event to secure your spot in the event
...
- `Create A Team` button to quickly create a new team <img src="/images/screenshots/event-join-create-team.png" alt="Event Join Create Team" />
