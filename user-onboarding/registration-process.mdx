...
- Enter a username, email address, and password, then confirm your password
- Submit to create your account. You will receive a verification email. Follow the link sent to your inbox
- On success, you are signed in automatically and redirected to `/home`. Errors are shown inline so you can retry

## Notes

- Username: up to 16 characters; letters, numbers, underscores, and dashes are allowed
