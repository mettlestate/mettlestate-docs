...
Administrators and tournament organisers can create custom matches for various purposes:

#### Admin-Created Matches

- **Admin Interface**: [PLACEHOLDER: Document admin match creation tools]
- **Match Customisation**: [PLACEHOLDER: Document what can be customized]
